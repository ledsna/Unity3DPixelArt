...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class UniversalResourceData : UniversalResourceDataBase
    {
        ...
        /// <summary>
        /// Camera Object ID texture. Contains the Object ID (x) and Submesh ID (y) if the DepthNormals Prepass pass is executed.
        /// </summary>
        public TextureHandle cameraObjectIDTexture
        {
            get => CheckAndGetTextureHandle(ref _cameraObjectIDTexture);
            internal set => CheckAndSetTextureHandle(ref _cameraObjectIDTexture, value);
        }
        private TextureHandle _cameraObjectIDTexture;

        /// <summary>
        /// Pixel Perfect Detail texture. Written to by the Forward pass as MRT slot 1 (or 2 with rendering layers).
        /// Marks pixels as important (1.0) for the super-sampling resolve downsampler.
        /// </summary>
        public TextureHandle pixelPerfectDetailTexture
        {
            get => CheckAndGetTextureHandle(ref _pixelPerfectDetailTexture);
            internal set => CheckAndSetTextureHandle(ref _pixelPerfectDetailTexture, value);
        }
        private TextureHandle _pixelPerfectDetailTexture;
        ...
        public override void Reset()
        {
            ...
            _cameraObjectIDTexture = TextureHandle.nullHandle;
            _pixelPerfectDetailTexture = TextureHandle.nullHandle;
