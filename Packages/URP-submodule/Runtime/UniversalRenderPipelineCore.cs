...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal static class ShaderGlobalKeywords
    {
        ...
        public static GlobalKeyword WritePixelPerfectDetail;
        ...
        public static void InitializeShaderGlobalKeywords()
        {
            ...
            ShaderGlobalKeywords.WritePixelPerfectDetail = GlobalKeyword.Create(ShaderKeywordStrings.WritePixelPerfectDetail);
    ...
    public static class ShaderKeywordStrings
    {
        ...
        /// <summary> Keyword used for writing Pixel Perfect Detail mask. </summary>
        public const string WritePixelPerfectDetail = "_WRITE_PIXEL_PERFECT_DETAIL";
