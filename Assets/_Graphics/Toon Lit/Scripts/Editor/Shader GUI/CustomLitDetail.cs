...
{
    public class CustomLitDetailGUI
    {
        public static class Styles
        {
            ...
            public static readonly GUIContent detailAlbedoMapScaleInfo = EditorGUIUtility.TrTextContent("Detail map scale is not 1.");
            public static readonly GUIContent detailAlbedoMapFormatError = EditorGUIUtility.TrTextContent("Texture is not in linear space.");
        }
        ...
        public static void DoDetailArea(LitProperties properties, MaterialEditor materialEditor)
        {
            ...
            {
                EditorGUILayout.LabelField(Styles.detailAlbedoMapScaleInfo, EditorStyles.helpBox);
            }
            ...
            {
                EditorGUILayout.LabelField(Styles.detailAlbedoMapFormatError, EditorStyles.helpBox);
            }
