...
void GetNeighbourUVs(half2 uv, half distance, out half2 neighbours[4])
{
    ...
    neighbours[0] = uv + half2(0,  offset.y);
    neighbours[1] = uv + half2(0, -offset.y);
    neighbours[2] = uv + half2( offset.x, 0);
    neighbours[3] = uv + half2(-offset.x, 0);
}
...
half OutlineType(half2 uv)
{
    ...
    half id_edge = step(0.5, id_diff_sum);
